function [ output_args ] =observed_objective(sufi2_in, observ_fold,begin_year,end_year,var_file_name,...
                               weight, INPRINT,goal_type_defalt)
...
%data=xlsread('Qilian_1990-2014_daily_data.xls');
 data=xlsread(strcat(observ_fold,var_file_name{kk}),sheet);
